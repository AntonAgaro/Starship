  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.buttons}>
        <Button type="primary" onClick={() => navigate(RouteUrls.game)}>
          Игра
        </Button>
        <Button type="primary" onClick={() => navigate(RouteUrls.profile)}>
          Профиль
        </Button>
        <Button type="primary" onClick={() => navigate(RouteUrls.forum)}>
          Форум
        </Button>
        <Button type="primary" onClick={() => navigate(RouteUrls.leaderBoard)}>
          Лидерборд
        </Button>
      </div>
